 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function n(N,G){var M=N.length;N.push(G);e:for(;0<M;){var Y=M-1>>>1,ae=N[Y];if(0<i(ae,G))N[Y]=G,N[M]=ae,M=Y;else break e}}function t(N){return N.length===0?null:N[0]}function l(N){if(N.length===0)return null;var G=N[0],M=N.pop();if(M!==G){N[0]=M;e:for(var Y=0,ae=N.length,_t=ae>>>1;Y<_t;){var fn=2*(Y+1)-1,P=N[fn],V=fn+1,F=N[V];if(0>i(P,M))V<ae&&0>i(F,P)?(N[Y]=F,N[V]=M,Y=V):(N[Y]=P,N[fn]=M,Y=fn);else if(V<ae&&0>i(F,M))N[Y]=F,N[V]=M,Y=V;else break e}}return G}function i(N,G){var M=N.sortIndex-G.sortIndex;return M!==0?M:N.id-G.id}if(typeof performance=="object"&&typeof performance.now=="function"){var r=performance;e.unstable_now=function(){return r.now()}}else{var a=Date,o=a.now();e.unstable_now=function(){return a.now()-o}}var s=[],d=[],u=1,m=null,p=3,h=!1,x=!1,y=!1,_=typeof setTimeout=="function"?setTimeout:null,g=typeof clearTimeout=="function"?clearTimeout:null,f=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function b(N){for(var G=t(d);G!==null;){if(G.callback===null)l(d);else if(G.startTime<=N)l(d),G.sortIndex=G.expirationTime,n(s,G);else break;G=t(d)}}function v(N){if(y=!1,b(N),!x)if(t(s)!==null)x=!0,mn(C);else{var G=t(d);G!==null&&fl(v,G.startTime-N)}}function C(N,G){x=!1,y&&(y=!1,g(S),S=-1),h=!0;var M=p;try{for(b(G),m=t(s);m!==null&&(!(m.expirationTime>G)||N&&!R());){var Y=m.callback;if(typeof Y=="function"){m.callback=null,p=m.priorityLevel;var ae=Y(m.expirationTime<=G);G=e.unstable_now(),typeof ae=="function"?m.callback=ae:m===t(s)&&l(s),b(G)}else l(s);m=t(s)}if(m!==null)var _t=!0;else{var fn=t(d);fn!==null&&fl(v,fn.startTime-G),_t=!1}return _t}finally{m=null,p=M,h=!1}}var w=!1,L=null,S=-1,E=5,A=-1;function R(){return!(e.unstable_now()-A<E)}function j(){if(L!==null){var N=e.unstable_now();A=N;var G=!0;try{G=L(!0,N)}finally{G?ve():(w=!1,L=null)}}else w=!1}var ve;if(typeof f=="function")ve=function(){f(j)};else if(typeof MessageChannel<"u"){var ln=new MessageChannel,Yn=ln.port2;ln.port1.onmessage=j,ve=function(){Yn.postMessage(null)}}else ve=function(){_(j,0)};function mn(N){L=N,w||(w=!0,ve())}function fl(N,G){S=_(function(){N(e.unstable_now())},G)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(N){N.callback=null},e.unstable_continueExecution=function(){x||h||(x=!0,mn(C))},e.unstable_forceFrameRate=function(N){0>N||125<N?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):E=0<N?Math.floor(1e3/N):5},e.unstable_getCurrentPriorityLevel=function(){return p},e.unstable_getFirstCallbackNode=function(){return t(s)},e.unstable_next=function(N){switch(p){case 1:case 2:case 3:var G=3;break;default:G=p}var M=p;p=G;try{return N()}finally{p=M}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(N,G){switch(N){case 1:case 2:case 3:case 4:case 5:break;default:N=3}var M=p;p=N;try{return G()}finally{p=M}},e.unstable_scheduleCallback=function(N,G,M){var Y=e.unstable_now();switch(typeof M=="object"&&M!==null?(M=M.delay,M=typeof M=="number"&&0<M?Y+M:Y):M=Y,N){case 1:var ae=-1;break;case 2:ae=250;break;case 5:ae=1073741823;break;case 4:ae=1e4;break;default:ae=5e3}return ae=M+ae,N={id:u++,callback:G,priorityLevel:N,startTime:M,expirationTime:ae,sortIndex:-1},M>Y?(N.sortIndex=M,n(d,N),t(s)===null&&N===t(d)&&(y?(g(S),S=-1):y=!0,fl(v,M-Y))):(N.sortIndex=ae,n(s,N),x||h||(x=!0,mn(C))),N},e.unstable_shouldYield=R,e.unstable_wrapCallback=function(N){var G=p;return function(){var M=p;p=G;try{return N.apply(this,arguments)}finally{p=M}}}})(Mc);Gc.exports=Mc;var tp=Gc.exports;/**
 * @license React
...
`:`>
`;let m,p;for(p=t.length;p>0;--p){const C=t[p-1];if(C!==`
`&&C!=="	"&&C!==" ")break}let h=t.substring(p);const x=h.indexOf(`
`);x===-1?m="-":t===h||x!==h.length-1?(m="+",r&&r()):m="",h&&(t=t.slice(0,-h.length),h[h.length-1]===`
`&&(h=h.slice(0,-1)),h=h.replace(Oo,`$&${d}`));let y=!1,_,g=-1;for(_=0;_<t.length;++_){const C=t[_];if(C===" ")y=!0;else if(C===`
`)g=_;else break}let f=t.substring(0,g<_?g+1:_);f&&(t=t.substring(f.length),f=f.replace(/\n+/g,`$&${d}`));let v=(y?d?"2":"1":"")+m;if(e&&(v+=" "+o(e.replace(/ ?[\r\n]+/g," ")),i&&i()),!u){const C=t.replace(/\n+/g,`
$&`).replace(/(?:^|\n)([\t ].*)(?:([\n\t ]*)\n(?![\n\t ]))?/g,"$1$2").replace(/\n+/g,`$&${d}`);let w=!1;const L=Yr(l,!0);a!=="folded"&&n!==D.BLOCK_FOLDED&&(L.onOverflow=()=>{w=!0});const S=Qr(`${f}${C}${h}`,d,Mo,L);if(!w)return`>${v}
${d}${S}`}return t=t.replace(/\n+/g,`$&${d}`),`|${v}
${d}${f}${t}${h}`}function tb(e,n,t,l){const{type:i,value:r}=e,{actualString:a,implicitKey:o,indent:s,indentStep:d,inFlow:u}=n;if(o&&r.includes(`
...
${a}
${d}
`}};function ll(e,{flow:n,indicator:t,next:l,offset:i,onError:r,parentIndent:a,startOnNewline:o}){let s=!1,d=o,u=o,m="",p="",h=!1,x=!1,y=null,_=null,g=null,f=null,b=null,v=null,C=null;for(const S of e)switch(x&&(S.type!=="space"&&S.type!=="newline"&&S.type!=="comma"&&r(S.offset,"MISSING_CHAR","Tags and anchors must be separated from the next token by white space"),x=!1),y&&(d&&S.type!=="comment"&&S.type!=="newline"&&r(y,"TAB_AS_INDENT","Tabs are not allowed as indentation"),y=null),S.type){case"space":!n&&(t!=="doc-start"||(l==null?void 0:l.type)!=="flow-collection")&&S.source.includes("	")&&(y=S),u=!0;break;case"comment":{u||r(S,"MISSING_CHAR","Comments must be separated from other tokens by white space characters");const E=S.source.substring(1)||" ";m?m+=p+E:m=E,p="",d=!1;break}case"newline":d?m?m+=S.source:(!v||t!=="seq-item-ind")&&(s=!0):p+=S.source,d=!0,h=!0,(_||g)&&(f=S),u=!0;break;case"anchor":_&&r(S,"MULTIPLE_ANCHORS","A node can have at most one anchor"),S.source.endsWith(":")&&r(S.offset+S.source.length-1,"BAD_ALIAS","Anchor ending in : is ambiguous",!0),_=S,C??(C=S.offset),d=!1,u=!1,x=!0;break;case"tag":{g&&r(S,"MULTIPLE_TAGS","A node can have at most one tag"),g=S,C??(C=S.offset),d=!1,u=!1,x=!0;break}case t:(_||g)&&r(S,"BAD_PROP_ORDER",`Anchors and tags must be after the ${S.source} indicator`),v&&r(S,"UNEXPECTED_TOKEN",`Unexpected ${S.source} in ${n??"collection"}`),v=S,d=t==="seq-item-ind"||t==="explicit-key-ind",u=!1;break;case"comma":if(n){b&&r(S,"UNEXPECTED_TOKEN",`Unexpected , in ${n}`),b=S,d=!1,u=!1;break}default:r(S,"UNEXPECTED_TOKEN",`Unexpected ${S.type} token`),d=!1,u=!1}const w=e[e.length-1],L=w?w.offset+w.source.length:i;return x&&l&&l.type!=="space"&&l.type!=="newline"&&l.type!=="comma"&&(l.type!=="scalar"||l.source!=="")&&r(l.offset,"MISSING_CHAR","Tags and anchors must be separated from the next token by white space"),y&&(d&&y.indent<=a||(l==null?void 0:l.type)==="block-map"||(l==null?void 0:l.type)==="block-seq")&&r(y,"TAB_AS_INDENT","Tabs are not allowed as indentation"),{comma:b,found:v,spaceBefore:s,comment:m,hasNewline:h,anchor:_,tag:g,newlineAfterProp:f,end:L,start:C??L}}function li(e){if(!e)return null;switch(e.type){case"alias":case"scalar":case"double-quoted-scalar":case"single-quoted-scalar":if(e.source.includes(`
`))return!0;if(e.end){for(const n of e.end)if(n.type==="newline")return!0}return!1;case"flow-collection":for(const n of e.items){for(const t of n.start)if(t.type==="newline")return!0;if(n.sep){for(const t of n.sep)if(t.type==="newline")return!0}if(li(n.key)||li(n.value))return!0}return!1;default:return!0}}function Bo(e,n,t){if((n==null?void 0:n.type)==="flow-collection"){const l=n.end[0];l.indent===e&&(l.source==="]"||l.source==="}")&&li(n)&&t(l,"BAD_INDENT","Flow end indicator should be more indented than parent",!0)}}function bf(e,n,t){const{uniqueKeys:l}=e.options;if(l===!1)return!1;const i=typeof l=="function"?l:(r,a)=>r===a||H(r)&&H(a)&&r.value===a.value;return n.some(r=>i(r.key,t))}const yc="All mapping items must start at the same column";function Cb({composeNode:e,composeEmptyNode:n},t,l,i,r){var u;const a=(r==null?void 0:r.nodeClass)??De,o=new a(t.schema);t.atRoot&&(t.atRoot=!1);let s=l.offset,d=null;for(const m of l.items){const{start:p,key:h,sep:x,value:y}=m,_=ll(p,{indicator:"explicit-key-ind",next:h??(x==null?void 0:x[0]),offset:s,onError:i,parentIndent:l.indent,startOnNewline:!0}),g=!_.found;if(g){if(h&&(h.type==="block-seq"?i(s,"BLOCK_AS_IMPLICIT_KEY","A block sequence may not be used as an implicit map key"):"indent"in h&&h.indent!==l.indent&&i(s,"BAD_INDENT",yc)),!_.anchor&&!_.tag&&!x){d=_.end,_.comment&&(o.comment?o.comment+=`
`+_.comment:o.comment=_.comment);continue}(_.newlineAfterProp||li(h))&&i(h??p[p.length-1],"MULTILINE_IMPLICIT_KEY","Implicit keys need to be on a single line")}else((u=_.found)==null?void 0:u.indent)!==l.indent&&i(s,"BAD_INDENT",yc);t.atKey=!0;const f=_.end,b=h?e(t,h,_,i):n(t,f,p,null,_,i);t.schema.compat&&Bo(l.indent,h,i),t.atKey=!1,bf(t,o.items,b)&&i(f,"DUPLICATE_KEY","Map keys must be unique");const v=ll(x??[],{indicator:"map-value-ind",next:y,offset:b.range[2],onError:i,parentIndent:l.indent,startOnNewline:!h||h.type==="block-scalar"});if(s=v.end,v.found){g&&((y==null?void 0:y.type)==="block-map"&&!v.hasNewline&&i(s,"BLOCK_AS_IMPLICIT_KEY","Nested mappings are not allowed in compact mappings"),t.options.strict&&_.start<v.found.offset-1024&&i(b.range,"KEY_OVER_1024_CHARS","The : indicator must be at most 1024 chars after the start of an implicit block mapping key"));const C=y?e(t,y,v,i):n(t,s,x,null,v,i);t.schema.compat&&Bo(l.indent,y,i),s=C.range[2];const w=new _e(b,C);t.options.keepSourceTokens&&(w.srcToken=m),o.items.push(w)}else{g&&i(b.range,"MISSING_CHAR","Implicit map keys need to be followed by map values"),v.comment&&(b.comment?b.comment+=`
`+v.comment:b.comment=v.comment);const C=new _e(b);t.options.keepSourceTokens&&(C.srcToken=m),o.items.push(C)}}return d&&d<s&&i(d,"IMPOSSIBLE","Map comment with trailing content"),o.range=[l.offset,s,d??s],o}function Lb({composeNode:e,composeEmptyNode:n},t,l,i,r){const a=(r==null?void 0:r.nodeClass)??$n,o=new a(t.schema);t.atRoot&&(t.atRoot=!1),t.atKey&&(t.atKey=!1);let s=l.offset,d=null;for(const{start:u,value:m}of l.items){const p=ll(u,{indicator:"seq-item-ind",next:m,offset:s,onError:i,parentIndent:l.indent,startOnNewline:!0});if(!p.found)if(p.anchor||p.tag||m)m&&m.type==="block-seq"?i(p.end,"BAD_INDENT","All sequence items must start at the same column"):i(s,"MISSING_CHAR","Sequence item without - indicator");else{d=p.end,p.comment&&(o.comment=p.comment);continue}const h=m?e(t,m,p,i):n(t,p.end,u,null,p,i);t.schema.compat&&Bo(l.indent,m,i),s=h.range[2],o.items.push(h)}return o.range=[l.offset,s,d??s],o}function fi(e,n,t,l){let i="";if(e){let r=!1,a="";for(const o of e){const{source:s,type:d}=o;switch(d){case"space":r=!0;break;case"comment":{t&&!r&&l(o,"MISSING_CHAR","Comments must be separated from other tokens by white space characters");const u=s.substring(1)||" ";i?i+=a+u:i=u,a="";break}case"newline":i&&(a+=s),r=!0;break;default:l(o,"UNEXPECTED_TOKEN",`Unexpected ${d} at node end`)}n+=s.length}}return{comment:i,offset:n}}const Ga="Block collections are not allowed within flow collections",Ma=e=>e&&(e.type==="block-map"||e.type==="block-seq");function kb({composeNode:e,composeEmptyNode:n},t,l,i,r){const a=l.start.source==="{",o=a?"flow map":"flow sequence",s=(r==null?void 0:r.nodeClass)??(a?De:$n),d=new s(t.schema);d.flow=!0;const u=t.atRoot;u&&(t.atRoot=!1),t.atKey&&(t.atKey=!1);let m=l.offset+l.start.source.length;for(let _=0;_<l.items.length;++_){const g=l.items[_],{start:f,key:b,sep:v,value:C}=g,w=ll(f,{flow:o,indicator:"explicit-key-ind",next:b??(v==null?void 0:v[0]),offset:m,onError:i,parentIndent:l.indent,startOnNewline:!1});if(!w.found){if(!w.anchor&&!w.tag&&!v&&!C){_===0&&w.comma?i(w.comma,"UNEXPECTED_TOKEN",`Unexpected , in ${o}`):_<l.items.length-1&&i(w.start,"UNEXPECTED_TOKEN",`Unexpected empty item in ${o}`),w.comment&&(d.comment?d.comment+=`
`+w.comment:d.comment=w.comment),m=w.end;continue}!a&&t.options.strict&&li(b)&&i(b,"MULTILINE_IMPLICIT_KEY","Implicit keys of flow sequence pairs need to be on a single line")}if(_===0)w.comma&&i(w.comma,"UNEXPECTED_TOKEN",`Unexpected , in ${o}`);else if(w.comma||i(w.start,"MISSING_CHAR",`Missing , between ${o} items`),w.comment){let L="";e:for(const S of f)switch(S.type){case"comma":case"space":break;case"comment":L=S.source.substring(1);break e;default:break e}if(L){let S=d.items[d.items.length-1];Q(S)&&(S=S.value??S.key),S.comment?S.comment+=`
`+L:S.comment=L,w.comment=w.comment.substring(L.length+1)}}if(!a&&!v&&!w.found){const L=C?e(t,C,w,i):n(t,w.end,v,null,w,i);d.items.push(L),m=L.range[2],Ma(C)&&i(L.range,"BLOCK_IN_FLOW",Ga)}else{t.atKey=!0;const L=w.end,S=b?e(t,b,w,i):n(t,L,f,null,w,i);Ma(b)&&i(S.range,"BLOCK_IN_FLOW",Ga),t.atKey=!1;const E=ll(v??[],{flow:o,indicator:"map-value-ind",next:C,offset:S.range[2],onError:i,parentIndent:l.indent,startOnNewline:!1});if(E.found){if(!a&&!w.found&&t.options.strict){if(v)for(const j of v){if(j===E.found)break;if(j.type==="newline"){i(j,"MULTILINE_IMPLICIT_KEY","Implicit keys of flow sequence pairs need to be on a single line");break}}w.start<E.found.offset-1024&&i(E.found,"KEY_OVER_1024_CHARS","The : indicator must be at most 1024 chars after the start of an implicit flow sequence key")}}else C&&("source"in C&&C.source&&C.source[0]===":"?i(C,"MISSING_CHAR",`Missing space after : in ${o}`):i(E.start,"MISSING_CHAR",`Missing , or : between ${o} items`));const A=C?e(t,C,E,i):E.found?n(t,E.end,v,null,E,i):null;A?Ma(C)&&i(A.range,"BLOCK_IN_FLOW",Ga):E.comment&&(S.comment?S.comment+=`
`+E.comment:S.comment=E.comment);const R=new _e(S,A);if(t.options.keepSourceTokens&&(R.srcToken=g),a){const j=d;bf(t,j.items,S)&&i(L,"DUPLICATE_KEY","Map keys must be unique"),j.items.push(R)}else{const j=new De(t.schema);j.flow=!0,j.items.push(R);const ve=(A??S).range;j.range=[S.range[0],ve[1],ve[2]],d.items.push(j)}m=A?A.range[2]:E.end}}const p=a?"}":"]",[h,...x]=l.end;let y=m;if(h&&h.source===p)y=h.offset+h.source.length;else{const _=o[0].toUpperCase()+o.substring(1),g=u?`${_} must end with a ${p}`:`${_} in block collection must be sufficiently indented and end with a ${p}`;i(m,u?"MISSING_CHAR":"BAD_INDENT",g),h&&h.source.length!==1&&x.unshift(h)}if(x.length>0){const _=fi(x,y,t.options.strict,i);_.comment&&(d.comment?d.comment+=`
`+_.comment:d.comment=_.comment),d.range=[l.offset,y,_.offset]}else d.range=[l.offset,y,y];return d}function Fa(e,n,t,l,i,r){const a=t.type==="block-map"?Cb(e,n,t,l,r):t.type==="block-seq"?Lb(e,n,t,l,r):kb(e,n,t,l,r),o=a.constructor;return i==="!"||i===o.tagName?(a.tag=o.tagName,a):(i&&(a.tag=i),a)}function Pb(e,n,t,l,i){var p;const r=l.tag,a=r?n.directives.tagName(r.source,h=>i(r,"TAG_RESOLVE_FAILED",h)):null;if(t.type==="block-seq"){const{anchor:h,newlineAfterProp:x}=l,y=h&&r?h.offset>r.offset?h:r:h??r;y&&(!x||x.offset<y.offset)&&i(y,"MISSING_CHAR","Missing newline after block sequence props")}const o=t.type==="block-map"?"map":t.type==="block-seq"?"seq":t.start.source==="{"?"map":"seq";if(!r||!a||a==="!"||a===De.tagName&&o==="map"||a===$n.tagName&&o==="seq")return Fa(e,n,t,i,a);let s=n.schema.tags.find(h=>h.tag===a&&h.collection===o);if(!s){const h=n.schema.knownTags[a];if(h&&h.collection===o)n.schema.tags.push(Object.assign({},h,{default:!1})),s=h;else return h?i(r,"BAD_COLLECTION_TYPE",`${h.tag} used for ${o} collection, but expects ${h.collection??"scalar"}`,!0):i(r,"TAG_RESOLVE_FAILED",`Unresolved tag: ${a}`,!0),Fa(e,n,t,i,a)}const d=Fa(e,n,t,i,a,s),u=((p=s.resolve)==null?void 0:p.call(s,d,h=>i(r,"TAG_RESOLVE_FAILED",h),n.options))??d,m=ee(u)?u:new D(u);return m.range=d.range,m.tag=a,s!=null&&s.format&&(m.format=s.format),m}function hf(e,n,t){const l=n.offset,i=Eb(n,e.options.strict,t);if(!i)return{value:"",type:null,comment:"",range:[l,l,l]};const r=i.mode===">"?D.BLOCK_FOLDED:D.BLOCK_LITERAL,a=n.source?Nb(n.source):[];let o=a.length;for(let y=a.length-1;y>=0;--y){const _=a[y][1];if(_===""||_==="\r")o=y;else break}if(o===0){const y=i.chomp==="+"&&a.length>0?`
`.repeat(Math.max(1,a.length-1)):"";let _=l+i.length;return n.source&&(_+=n.source.length),{value:y,type:r,comment:i.comment,range:[l,_,_]}}let s=n.indent+i.indent,d=n.offset+i.length,u=0;for(let y=0;y<o;++y){const[_,g]=a[y];if(g===""||g==="\r")i.indent===0&&_.length>s&&(s=_.length);else{_.length<s&&t(d+_.length,"MISSING_CHAR","Block scalars with more-indented leading empty lines must use an explicit indentation indicator"),i.indent===0&&(s=_.length),u=y,s===0&&!e.atRoot&&t(d,"BAD_INDENT","Block scalar values in collections must be indented");break}d+=_.length+g.length+1}for(let y=a.length-1;y>=o;--y)a[y][0].length>s&&(o=y+1);let m="",p="",h=!1;for(let y=0;y<u;++y)m+=a[y][0].slice(s)+`
`;for(let y=u;y<o;++y){let[_,g]=a[y];d+=_.length+g.length+1;const f=g[g.length-1]==="\r";if(f&&(g=g.slice(0,-1)),g&&_.length<s){const v=`Block scalar lines must not be less indented than their ${i.indent?"explicit indentation indicator":"first line"}`;t(d-g.length-(f?2:1),"BAD_INDENT",v),_=""}r===D.BLOCK_LITERAL?(m+=p+_.slice(s)+g,p=`
`):_.length>s||g[0]==="	"?(p===" "?p=`
`:!h&&p===`
`&&(p=`
